                    ...
                    <div key={buttonId} className="flex items-center gap-2">
                      {isEditing ? (
                        <>
                          ...
                          />
                          <button
                            onClick={() => moveButton(groupId, buttonId, "up")}
                            className="bg-gray-300 hover:bg-gray-400 text-xs px-2 py-1 rounded"
                          >↑</button>
                          <button
                            onClick={() => moveButton(groupId, buttonId, "down")}
                            className="bg-gray-300 hover:bg-gray-400 text-xs px-2 py-1 rounded"
                          >↓</button>
                          <button
                        ...
                        <>
                          ...
                          {!button.isActive ? (
                            <button
                              onClick={() => handleRestore(groupId, buttonId)}
                              className="bg-green-500 hover:bg-green-600 text-white px-1 py-0.5 rounded text-[10px]"
                            >↩</button>
                          ) : (
                            <button
                              onClick={() => handleDisable(groupId, buttonId)}
